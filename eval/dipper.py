...
class DipperParaphraser(object):
    def __init__(self, model="/data3/wcr/my_lab/hf_models/dipper", verbose=True):
        time1 = time.time()
        self.tokenizer = T5Tokenizer.from_pretrained('/data3/wcr/my_lab/hf_models/t5')
...
if __name__ == "__main__":
    ...
    output_l60_sample = dp.paraphrase(input_text, lex_diversity=60, order_diversity=0, prefix=prompt, do_sample=True, top_p=0.75, top_k=None, max_length=1024)
